		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App DLG04",
									"targetURL": "#Logaligroupdlg04apphtmldlg04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Logaligroupdlg04apphtmldlg04-display": {
								"semanticObject": "Logaligroupdlg04apphtmldlg04",
								"action": "display",
								"description": "A Fiori application. dlg04",
								"title": "App DLG04",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Logaligroupdlg04.apphtmldlg04",
									"url": sap.ui.require.toUrl("Logaligroupdlg04/apphtmldlg04")
								}
							}
						}
					}
