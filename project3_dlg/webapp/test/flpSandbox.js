		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dlg03project3dlg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dlg03project3dlg-display": {
								"semanticObject": "dlg03project3dlg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dlg03.project3dlg",
									"url": sap.ui.require.toUrl("dlg03/project3dlg")
								}
							}
						}
					}
