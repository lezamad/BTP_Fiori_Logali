		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App DLG03",
									"targetURL": "#Logaligroupdlg03apphtmldlg03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Logaligroupdlg03apphtmldlg03-display": {
								"semanticObject": "Logaligroupdlg03apphtmldlg03",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Logaligroupdlg03.apphtmldlg03",
									"url": sap.ui.require.toUrl("Logaligroupdlg03/apphtmldlg03")
								}
							}
						}
					}
