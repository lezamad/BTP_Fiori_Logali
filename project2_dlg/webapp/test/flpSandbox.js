		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dlgproject2dlg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dlgproject2dlg-display": {
								"semanticObject": "dlgproject2dlg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dlg.project2dlg",
									"url": sap.ui.require.toUrl("dlg/project2dlg")
								}
							}
						}
					}
