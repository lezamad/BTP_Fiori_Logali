		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App DLG Yeoman",
									"targetURL": "#Logaliyeomanapphtmlyeoman-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Logaliyeomanapphtmlyeoman-display": {
								"semanticObject": "Logaliyeomanapphtmlyeoman",
								"action": "display",
								"description": "Logali Yeoman. example Num 02",
								"title": "App DLG Yeoman",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Logaliyeoman.apphtmlyeoman",
									"url": sap.ui.require.toUrl("Logaliyeoman/apphtmlyeoman")
								}
							}
						}
					}
