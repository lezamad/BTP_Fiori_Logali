		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Odata 02. DLG05",
									"targetURL": "#LogaliOdataprojectdlg0501-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LogaliOdataprojectdlg0501-display": {
								"semanticObject": "LogaliOdataprojectdlg0501",
								"action": "display",
								"description": "A Fiori application. Odata. DLG05-02",
								"title": "App Odata 02. DLG05",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=LogaliOdata.projectdlg0501",
									"url": sap.ui.require.toUrl("LogaliOdata/projectdlg0501")
								}
							}
						}
					}
